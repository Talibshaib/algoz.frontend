...
const Footer = () => {
  return (
    <footer className="py-16 bg-gray-50 text-gray-800 border-t border-gray-200">
      <div className="container mx-auto px-4">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* About Us Column */}
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-4 text-gray-900">About AlgoZ</h3>
          ...
          {/* MORE LINK Column */}
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-4 text-gray-900">MORE LINKS</h3>
          ...
          {/* PAGES Column */}
          <div className="col-span-1">
            <h3 className="text-xl font-bold mb-4 text-gray-900">PAGES</h3>
            <ul className="space-y-3">
              <li>
                <Link 
                  href="/privacy-policy" 
            ...
            <ul className="space-y-3">
              ...
              <li className="pt-4">
                ...
                <div className="flex space-x-3">
                  ...
                  <MotionDiv whileHover={{ y: -3, scale: 1.1 }} transition={{ duration: 0.2 }}>
                    <a href="#" className="w-8 h-8 bg-sky-500 rounded-full flex items-center justify-center hover:bg-sky-600 transition-colors duration-300">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-4 md:grid-cols-8 gap-4 mb-10">
          ...
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
              <FaCcVisa className="text-blue-700 text-xl" />
              <span className="text-gray-800 font-medium text-xs ml-1">VISA</span>
            </div>
          </MotionDiv>
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
              <FaCcMastercard className="text-red-600 text-xl" />
              <span className="text-gray-800 font-medium text-xs ml-1">MasterCard</span>
            </div>
          </MotionDiv>
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
              <CgPaypal className="text-blue-600 text-xl" />
              <span className="text-gray-800 font-medium text-xs ml-1">PayPal</span>
            </div>
          </MotionDiv>
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
          ...
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
              <FaGooglePay className="text-gray-800 text-xl" />
              <span className="text-gray-800 font-medium text-xs ml-1">G Pay</span>
            </div>
          </MotionDiv>
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
              <SiPaytm className="text-blue-500 text-xl" />
              <span className="text-gray-800 font-medium text-xs ml-1">Paytm</span>
            </div>
          </MotionDiv>
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
              <FaPhoneAlt className="text-purple-600 text-sm" />
              <span className="text-gray-800 font-medium text-xs ml-1">PhonePe</span>
            </div>
          </MotionDiv>
          <MotionDiv whileHover={{ y: -5, boxShadow: "0 4px 12px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
            <div className="bg-white p-2 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm">
