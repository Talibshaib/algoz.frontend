...
const Footer = () => {
  return (
    <footer className="py-16 bg-gradient-to-b from-white to-gray-50 text-gray-800 border-t border-gray-200">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          >
            <h3 className="text-xl font-bold mb-4 text-gray-900 relative inline-block">
              About AlgoZ
              <span className="absolute -bottom-1 left-0 w-1/2 h-0.5 bg-gradient-to-r from-blue-600 to-purple-600"></span>
            </h3>
          ...
          >
            ...
            <ul className="space-y-3">
              <li>
                <Link 
                  href="/community" 
                  className="text-gray-600 hover:text-blue-600 text-sm transition-colors duration-200 flex items-center"
                >
          ...
          >
            ...
            <ul className="space-y-3">
              <li>
                ...
                <Link 
                  href="/channel" 
                  className="text-blue-600 hover:text-blue-800 text-sm transition-colors duration-200 flex items-center"
                >
                  <span className="hover:translate-x-1 transition-transform duration-200 inline-block">
                    AlgoZ Channel
                  </span>
              ...
              <li className="pt-4">
                ...
                <div className="flex space-x-3">
                  <MotionDiv whileHover={{ y: -3, scale: 1.1 }} transition={{ duration: 0.2 }}>
                    <a href="#" className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-300 shadow-sm">
                  ...
                  <MotionDiv whileHover={{ y: -3, scale: 1.1 }} transition={{ duration: 0.2 }}>
                    <a href="#" className="w-8 h-8 bg-sky-500 rounded-full flex items-center justify-center hover:bg-sky-600 transition-colors duration-300 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <MotionDiv whileHover={{ y: -3, scale: 1.1 }} transition={{ duration: 0.2 }}>
                    <a href="#" className="w-8 h-8 bg-red-600 rounded-full flex items-center justify-center hover:bg-red-700 transition-colors duration-300 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <MotionDiv whileHover={{ y: -3, scale: 1.1 }} transition={{ duration: 0.2 }}>
                    <a href="#" className="w-8 h-8 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-800 transition-colors duration-300 shadow-sm">
                      <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <MotionDiv 
          ...
          viewport={{ once: true }}
        >
          <h4 className="text-center text-sm font-medium text-gray-500 mb-6">ACCEPTED PAYMENT METHODS</h4>
          <div className="grid grid-cols-4 md:grid-cols-8 gap-4">
            {/* Payment method items with hover effect */}
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <FaCcVisa className="text-blue-700 text-2xl" />
                <span className="text-gray-800 font-medium text-xs ml-2">VISA</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <FaCcMastercard className="text-red-600 text-2xl" />
                <span className="text-gray-800 font-medium text-xs ml-2">MasterCard</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <CgPaypal className="text-blue-600 text-2xl" />
                <span className="text-gray-800 font-medium text-xs ml-2">PayPal</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <FaRupeeSign className="text-green-600 text-xl mr-1" />
                <span className="text-gray-800 font-medium text-xs">RuPay</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <FaGooglePay className="text-gray-800 text-2xl" />
                <span className="text-gray-800 font-medium text-xs ml-2">G Pay</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <SiPaytm className="text-blue-500 text-2xl" />
                <span className="text-gray-800 font-medium text-xs ml-2">Paytm</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <FaPhoneAlt className="text-purple-600 text-sm mr-1" />
                <span className="text-gray-800 font-medium text-xs">PhonePe</span>
              </div>
            </MotionDiv>
            <MotionDiv whileHover={{ y: -5, boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1)" }} transition={{ duration: 0.2 }}>
              <div className="bg-white p-3 rounded-lg flex items-center justify-center border border-gray-200 shadow-sm h-14">
                <SiBitcoinsv className="text-blue-800 text-xl mr-1" />
                <span className="text-gray-800 font-medium text-xs">BHIM</span>
              </div>
            </MotionDiv>
          </div>
        </MotionDiv>
